...
load("C:/Users/Sarah.HOME/OneDrive/ETH/Master/Neuro FS22/Bioinformatic approaches to regulatory genomics/Project/myObjects.RData")
...
```{r, eval=FALSE}
save(peaks_creb1_chr1, peaks_creb3_chr1, peaks_creb5_chr1, peaks_creb3l1_chr1, file="objecs_p3.RData")
```