...
So overall CREB1 is strongly present 7/10 times, CREB3 5/10 times, CREB3L1 6/10 times and CREB5 has a medium strong presence 2/10 times.
...
```
Bring the curves into the interpretation!
...
Now we only did this for cluster 2 compared to all clusters. We need to do more comparisons like this and figure out what cluster stands for what.
